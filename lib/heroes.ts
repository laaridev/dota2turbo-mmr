// Hero ID to CDN slug mapping
// Based on Dota 2 hero IDs from OpenDota API
export const HERO_SLUGS: Record<number, string> = {
    1: 'antimage',
    2: 'axe',
    3: 'bane',
    4: 'bloodseeker',
...
export const HERO_NAMES: Record<number, string> = {
    ...
    129: 'Mars', 135: 'Dawnbreaker', 136: 'Marci', 137: 'Primal Beast', 138: 'Muerta', 145: 'Ringmaster',
};

export function getHeroImageUrl(heroId: number): string {
    const slug = HERO_SLUGS[heroId];
    if (!slug) return '';
    return `https://cdn.steamstatic.com/apps/dota2/images/dota_react/heroes/${slug}.png`;
}
