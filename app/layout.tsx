          ...
          <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-background/60 backdrop-blur-xl transition-all">
            <div className="container flex h-16 items-center space-x-4 sm:justify-between sm:space-x-0 mx-auto px-4">
              <div className="flex gap-2 items-center">
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-primary to-orange-500 box-glow flex items-center justify-center font-bold text-white text-sm">TB</div>
                <span className="font-bold text-xl tracking-tight"><span className="bg-gradient-to-r from-primary to-orange-400 bg-clip-text text-transparent">Turbo</span><span className="text-white">Buff</span></span>
              </div>
